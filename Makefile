...
all: nms_seq nms_simd nms_omp nms_tbb nms_simd_tbb nms_tbb_old nms_simd_tbb_old
...
clean:
	rm -f nms_seq.out nms_simd.out nms_omp.out nms_tbb.out nms_simd_tbb.out nms_tbb_old.out nms_simd_tbb_old.out